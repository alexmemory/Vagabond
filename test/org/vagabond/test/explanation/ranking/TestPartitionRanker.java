...
public class TestPartitionRanker extends AbstractVagabondTest {
	...
	public void testSimplePartitionSideEffect () throws Exception {
		...
		AStarExplanationRanker r1 = (AStarExplanationRanker) (((PartitionRanker) ranker).getRankerForPart(0));
		AStarExplanationRanker r2 = (AStarExplanationRanker) (((PartitionRanker) ranker).getRankerForPart(1));
	...
	public void useTwoPartRankers () throws Exception {
			...
			PartitionRanker pr1 = (PartitionRanker) RankerFactory.createPartRanker("ExplSize", e);
			pr1.rankFull();
