...
public class TestExpalanationSizeFunctions extends AbstractVagabondTest {
	...
	@Test
	public void testExpalanationSize () throws Exception {
		IScoringFunction f = new  ExplanationSizeScore();
