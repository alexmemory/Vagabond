...
public class BloomFilter<E> implements Serializable {
    ...
    /**
      ...
      */
    public BloomFilter(double c, int n, int k, BitsetType bitsetType) {
      ...
      switch(bitsetType) {
      case JavaBitSet:
    	  this.bitset = new JavaUtilBitSet(bitSetSize);
    	  break;
      case EWAHBitSet:
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOElements, BitsetType bitsetType) {
        this(bitSetSize / (double)expectedNumberOElements,
             expectedNumberOElements,
             (int) Math.round((bitSetSize / (double)expectedNumberOElements) * Math.log(2.0)), bitsetType);
    }
     ...
     */
    public BloomFilter(double falsePositiveProbability, int expectedNumberOfElements, BitsetType bitSetType) {
        this(Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2), // c = k / ln(2)
             expectedNumberOfElements,
             (int)Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))), bitSetType); // k = ceil(-log_2(false prob.))
    }
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, IBitSet filterData) {
        this(bitSetSize, expectedNumberOfFilterElements, BitsetType.JavaBitSet);
