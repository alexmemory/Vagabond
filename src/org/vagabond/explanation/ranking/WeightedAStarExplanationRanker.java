...
public class WeightedAStarExplanationRanker implements IExplanationRanker {
		...
		public int compare(RankedListElement o1, RankedListElement o2) {
			...
			for(int i = 0; i < o1.elem.length; i++) {
				...
				if (o1.elem[i] != o2.elem[i]) {
					// check with real element and not placeholder -2 for element set elsewhere
	...
	public static final Comparator<OneErrorExplSet> oneElemComp = 
			new Comparator<WeightedAStarExplanationRanker.OneErrorExplSet>() {
	...
	public WeightedAStarExplanationRanker (IScoringFunction f) {
